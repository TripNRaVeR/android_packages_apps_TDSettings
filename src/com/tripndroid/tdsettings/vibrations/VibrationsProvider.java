...
package com.tripndroid.tdsettings.vibrations;
...
public class VibrationsProvider extends ContentProvider
{
    ...
    public static final String PROVIDER_NAME =
            "com.tripndroid.tdsettings.Vibrations";
    ...
    private static final String TRIPNDROIDVibrationName = "'TRIPNDROID'";
    private static final String TRIPNDROIDVibrationPattern = "'500,150,400,400,400,400,400,400,400,400,400,400,150,150,400,400,150,150,400,400,400,400,150,150,150'";
    ...
    private static final String DATABASE_INIT_TRIPNDROID =
            "insert into names (name, pattern) " +
                    "values (" + TRIPNDROIDVibrationName + ", " + TRIPNDROIDVibrationPattern + ")";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper
    {
        ...
        public void onCreate(SQLiteDatabase db)
        {
            ...
            db.execSQL(DATABASE_INIT_TRIPNDROID);
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case VIBRATIONS: // ---get all vibrations---
                return "vnd.android.cursor.dir/vnd.tdsettings.vibrations";
            case VIBRATION_ID: // ---get a particular vibration---
                return "vnd.android.cursor.item/vnd.tdsettings.vibrations";
            default:
