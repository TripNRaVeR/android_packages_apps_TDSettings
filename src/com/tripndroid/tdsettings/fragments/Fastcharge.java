...
public class Fastcharge extends PerformanceSettings implements OnPreferenceChangeListener {

    private static final String FILE = "/sys/td_framework/fast_charge";
    ...
    public static void restore(Context context) {
        ...
        boolean enabled = sharedPrefs.getBoolean(TDF_FASTCHARGE, false);
        if(enabled)
